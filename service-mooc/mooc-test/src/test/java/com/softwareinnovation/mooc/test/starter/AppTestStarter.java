package com.softwareinnovation.mooc.test.starter;
...
import com.softwareinnovation.mooc.AppStarter;
...
public class AppTestStarter {
    ...
    private static final int DB_PORT = 54930;

    private static final String DB_SCHEMA = "ddirdk";
    ...
    private static final String ARTIFACT_ID = "mooc";
