package com.softwareinnovation.mooc.mooc.web;
...
public class VideoController {
  ...
  public Map<String, Object> getSimpleMapByPK(@RequestParam(value = "id", required = true) String id) {
    return Status.successBuilder()
        .addDataValue(videoService.getSimpleMapByPK(id))
        .map();
  }
  ...
  public Map<String, Object> getDetailMapByPK(@RequestParam(value = "id", required = true) String id) {
    return Status.successBuilder()
        .addDataValue(videoService.getDetailMapByPK(id))
        .map();
  }
  ...
  public Map<String, Object> getFilterMapList(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.rows = rows;
    return Status.successBuilder()
        .addDataValue(videoService.getFilterMapList(mapper))
        .addDataCount(videoService.getCountByFilter(mapper))
        .map();
  }
  ...
  public Map<String, Object> getFilterDetailMapList(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.rows = rows;
    return Status.successBuilder()
        .addDataValue(videoService.getFilterDetailMapList(mapper))
        .addDataCount(videoService.getCountByFilter(mapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> post(@RequestBody VideoPostMapper postMapper) {
    return Status.successBuilder()
        .addDataValue(videoService.post(postMapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> postBatch(@RequestBody ArrayList<VideoPostMapper> postMappers) {
    return Status.successBuilder()
        .addDataValue(videoService.postList(postMappers))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> patch(@RequestBody VideoUpdateMapper updateMapper) {
    return Status.successBuilder()
        .addDataValue(videoService.update(updateMapper))
        .map();
  }
  ...
  public Map<String, Object> delete(@RequestParam(value = "id", required = true) String id) {
    return Status.successBuilder()
        .addDataValue(videoService.delete(id))
        .map();
  }
  ...
  public Map<String, Object> deleteBatch(@RequestParam("entityKeys") ArrayList<String> entityKeys) {
    return Status.successBuilder()
        .addDataValue(videoService.deleteList(entityKeys))
        .map();
  }
}
